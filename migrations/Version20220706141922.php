 ...
 */
final class Version20220706141922 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD category_id INT DEFAULT NULL, ADD tags_id INT DEFAULT NULL, ADD body LONGTEXT NOT NULL, ADD published_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP category_id, DROP tags_id, DROP body, DROP published_at');
    }
}
